...
export interface IStockMovement extends Document {
  ...
  quantity: number;
  movementDate: Date;
  sourceType: 'floor_check' | 'manual' | 'adjustment' | 'transfer' | 'damage' | 'return' | 'spoilage' | 'purchase_order' | 'receiving' | 'client_request';
...
const stockMovementSchema = new Schema<IStockMovement>(
  {
    ...
    sourceType: {
      type: String,
      enum: ['floor_check', 'manual', 'adjustment', 'transfer', 'damage', 'return', 'spoilage', 'purchase_order', 'receiving', 'client_request'],
      default: 'manual',
    },
