...
const EMPTY: MRForm = { title:'', description:'', project:'', building:'', floor:'', category:'electrical', priority:'medium', notes:'' };
...
export function MaintenanceNewPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <form className="card p-6 space-y-4" onSubmit={e => { e.preventDefault(); mutation.mutate({ ...form, floor: form.floor || undefined, building: form.building || undefined }); }}>
        <div>
